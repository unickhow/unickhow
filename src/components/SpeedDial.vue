<template>
  <div
    ...
    <!-- <MdiArrowUpBold /> -->
    <RiAppsFill class="text-2xl transform transition" :class="{ 'rotate-45 text-orange': isDialing }" />
    <div class="dial-menu">
      <router-link :to="{ name: 'Home' }" :class="{'!right-17 !opacity-100 !pointer-events-auto': isDialing}">
        <riSeedlingFill />
      </router-link>
